  ...
  map_output <- map_output %>%
    addEasyButton(
      easyButton(
        ...
        onClick = JS("alert('Klicken Sie auf eine Schulmarke für Details. Nutzen Sie die +/- Buttons zum Zoomen.')")
      )
    )
}, error = function(e) {
