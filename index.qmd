...
subtitle: "Welche Schule haben welche Noten für die Aufnahme nach der 7. Klasse"
...
schulen <- get_school_mapdata() |>
  ...
  dplyr::filter(schultyp %in% c("Integrierte Sekundarschule", "Gymnasium", "Gemeinschaftsschule")) |>
...
* Gerne Verbesserungsvorschläge in die  [Issues im Github Repository](https://github.com/jakobschumacher/schulnoten_berlin/issues)
schreiben. Benötigt einen Github account.
